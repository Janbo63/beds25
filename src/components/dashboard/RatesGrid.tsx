...
export default function RatesGrid() {
    ...
    if (loading || !data) return <div className="p-8 text-neutral-500">{t('loading')}</div>;
                                ...
                                <tr key={rt.id} className="border-t border-neutral-200 dark:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-800/30 transition-colors">
                                    ...
                                    {data.days.map((day: string) => {
                                        ...
                                        return (
                                            <td
                                                key={day}
                                                className={`p-4 border-r border-neutral-200 dark:border-neutral-800 text-center cursor-pointer hover:bg-blue-600/10 transition-colors ${priceData ? 'bg-blue-600/5' : ''}`}
                                            ...
                                            >
                                                {isEditing ? (
                                                    ...
                                                    <div className="flex flex-col">
                                                        ...
                                                        {priceData && <span className="text-[10px] text-blue-500 font-bold uppercase">{t('manual')}</span>}
                                                    </div>
                                                )}
                                            </td>
                                        );
