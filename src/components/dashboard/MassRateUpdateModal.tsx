...
export default function MassRateUpdateModal({ roomId, roomNumber, onClose, onSave }: MassRateUpdateModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
            <div className="bg-neutral-900 border border-white/10 rounded-3xl w-full max-w-md shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
                <div className="p-6 border-b border-white/5 flex justify-between items-center bg-gradient-to-r from-blue-600/20 to-transparent">
                    <div>
                        <h3 className="text-xl font-bold text-white leading-tight">Mass Rate Update</h3>
                        <p className="text-xs text-neutral-400 mt-1 uppercase tracking-widest">Room {roomNumber}</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                type="date"
                                className="w-full bg-neutral-800 border-2 border-neutral-700/50 rounded-xl px-4 py-2 text-white text-sm outline-none focus:border-blue-500 transition-colors"
                                value={startDate}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                type="number"
                                placeholder="0.00"
                                className="w-full bg-neutral-800 border-2 border-neutral-700/50 rounded-xl pl-4 pr-12 py-3 text-white font-bold text-lg outline-none focus:border-hotel-gold transition-colors"
                                value={price}
                ...
                <div className="p-6 bg-black/20 flex gap-4">
                    <button
                        className="flex-1 py-3 bg-neutral-800 hover:bg-neutral-700 text-white rounded-xl font-bold transition-all border border-white/5 text-sm"
                        onClick={onClose}
                    >
                        Cancel
                    </button>
